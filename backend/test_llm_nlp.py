#!/usr/bin/env python3
"""
Test script for LLM-based NLP processor
"""
...
from chatbot.llm_nlp_processor import LLMMedicalNLPProcessor

async def test_llm_nlp():
    """Test the LLM-based NLP processor"""
    ...
    try:
        ...
        print("🤖 Initializing LLM-based NLP processor...")
        nlp_processor = LLMMedicalNLPProcessor(api_key=api_key)
...
if __name__ == "__main__":
    success = asyncio.run(test_llm_nlp())
